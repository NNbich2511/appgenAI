...
from genAIscreen.genAIscreen import genAIscreen
...
class MyApp(App):
    def build(self):
        ...
        sm.add_widget(genAIscreen(name="genAIscreen"))
        return sm
...
kv_path_genAI = os.path.join(os.path.dirname(__file__), "genAIscreen", "genAIscreen.kv")
Builder.load_file(kv_path_login)
Builder.load_file(kv_path_home)
Builder.load_file(kv_path_user)
Builder.load_file(kv_path_genAI)
